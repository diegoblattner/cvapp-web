...
},{}],"components/Profile/component.jsx":[function(require,module,exports) {
"use strict";
...
var Profile = function Profile(profileProps) {
  var avatar = profileProps.avatar,
      name = profileProps.name,
      position = profileProps.position,
      github = profileProps.github,
      linkedin = profileProps.linkedin,
      email = profileProps.email;
  return (0, _preact.h)("header", null, (0, _preact.h)("div", null, (0, _preact.h)("img", {
    src: avatar,
    alt: name
  }), (0, _preact.h)("h1", null, name), (0, _preact.h)("h2", null, position)), (0, _preact.h)("div", null, (0, _preact.h)("a", {
    href: github
  }, "GitHub"), (0, _preact.h)("a", {
    href: linkedin
  }, "Linkedin"), (0, _preact.h)("a", {
    href: "mailto:".concat(email)
  }, "E-mail")));
};

exports.Profile = Profile;
},{"preact":"../node_modules/preact/dist/preact.mjs"}],"components/Skills/component.jsx":[function(require,module,exports) {
"use strict";
...
var Skills = function Skills(skillsProps) {
  return (0, _preact.h)("section", null, (0, _preact.h)("h3", null, "Skills"), (0, _preact.h)("ul", null, skillsProps.skills.map(function (skill, index) {
...
},{"./bundle-url":"../node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"components/App/component.jsx":[function(require,module,exports) {
"use strict";
...
var _component = require("../Profile/component");

var _component2 = require("../Skills/component");
...
var UIStates = {
  ...
  loaded: function loaded(_ref) {
    var profile = _ref.profile,
        skills = _ref.skills;
    return (0, _preact.h)("div", null, (0, _preact.h)(_component.Profile, profile), (0, _preact.h)(_component2.Skills, {
      skills: skills
    }));
  },
  error: function error() {
    return (0, _preact.h)("div", null, (0, _preact.h)("b", null, "Something went astray =("), (0, _preact.h)("small", null, "Refreshing the page might work"));
  }
};
...
function (_Component) {
  ...
  function App() {
    ...
    _this.state.uiState = UIStates.loading;
    _this.cvData = {};
    return _this;
  }
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _context.next = 3;
                return require("_bundle_loader")(require.resolve('../../../mock/cv-data.json'));
              ...
              case 7:
                ...
                console.error('error loading the json', _context.t0); // TODO: log error...
...
exports.App = App;
},{"preact":"../node_modules/preact/dist/preact.mjs","../Profile/component":"components/Profile/component.jsx","../Skills/component":"components/Skills/component.jsx","_bundle_loader":"../node_modules/parcel-bundler/src/builtins/bundle-loader.js","../../../mock/cv-data.json":[["cv-data.5e1d9cb0.js","../mock/cv-data.json"],"cv-data.5e1d9cb0.js.map","../mock/cv-data.json"]}],"index.js":[function(require,module,exports) {
"use strict";
